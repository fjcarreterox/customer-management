...
if(strcmp($services["periodicidad"],"Pago único")!==0 && strcmp($services["periodicidad"],"anualmente")!==0){
    $per=$periodo_ops[$services["periodicidad"]].".";
    $div=' dividido en '.$services["periodicidad"].' importes de '.$services["cuota"].' EUROS,';
}
$pdf->MultiCell(0,6,utf8_decode('El precio fijado para los servicios de asesoría descritos, a ser percibido por ANÁLISIS Y GESTIÓN DE DATOS S.L., asciende a un total de '.$services["importe"].' EUROS,'.$div.' impuestos no incluidos, que serán facturados y domiciliados por dicha entidad '.$per),0);
$pdf->Ln(5);
